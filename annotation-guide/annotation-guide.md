...
> Q: 如果音频中出现了文本以外的含元音字怎么办？
> A: 如果你能判断是哪个元音就标注出来，否则可以记录下来报告给我。

> Q: 如果自动标的音标错了怎么办？
> A: 如果你很确信确实是标错了，即本来不是 iyauo 中的一种，却被标成了 iyauo 中的一种，那你就直接删掉这个标注文本。

> Q: 我发现这个人读了[标注文本](#标注文本)以外的内容，我要管吗？
> A: 忽略掉。
...
>
> 1. 你标注的区间听起来的确是这个音
> 2. 参考区间内的音高、强度、共振峰，让它们的变化尽可能小
> 3. 和相邻区间一起听，确保你把不同音之间的过渡分得比较开
...
目的是校对 i, y, a, u, o（衣、于、啊、乌、哦）五种元音的标注区间，将其调整到准确的位置。下面会用粗体把含元音的字标记出来，并附部分该元音的频谱图以供参考。斜体字表示这个字可能有口音变化，参阅[关于口音](#关于口音)。
...
- 有的人会把 e 发成 o，比如“可以”说成“阔以”，“着”说成 zhuo。自动标注经常会把 e 标成 o，需要判断是否确实为 o。
